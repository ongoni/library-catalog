                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row text-center justify-content-center">
                                <form method="GET" action="{{ route('book.edit', $book->id) }}" class="col-sm-3">
                                ...
                                <form method="GET" action="{{ route('book.show', $book->id) }}" class="col-sm-3">
                                    <button class="btn btn-outline-dark">
                                ...
                                <form method="POST" action="{{ route('book.destroy', $book->id) }}" class="col-sm-3">
                                    @csrf
